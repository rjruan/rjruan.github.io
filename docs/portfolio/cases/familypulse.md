...
- Public routes: `/expeditions/health-monitoring/` and `/zh/expeditions/health-monitoring/`.
- Complete English and Traditional Chinese case studies are published.
- Context: individual UX Design class project, September–December 2024.
- Role: sole UX researcher and designer.
- Framing: dignity-centered connected support for older adults and trusted contacts; this is a course concept, not a medical device.
...
- Keep the English and Chinese narrative facts, evidence limits, hierarchy, images, captions, and alt meanings aligned.
